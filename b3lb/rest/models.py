...
class Parameter(Model):
    ...
    PARAMETER_REGEXES = {
        # Create
        WELCOME: ANY_REGEX,
        DIAL_NUMBER: NUMBER_REGEX,
        VOICE_BRIDGE: NUMBER_REGEX,
    ...
    PARAMETERS_CREATE = [ALLOW_MODS_TO_UNMUTE_USERS, ALLOW_START_STOP_RECORDING, AUTO_START_RECORDING,
                         BANNER_COLOR, BANNER_TEXT, COPYRIGHT, DIAL_NUMBER, DURATION, END_WHEN_NO_MODERATOR,
                         END_WHEN_NO_MODERATOR_DELAY_IN_MINUTES, GUEST_POLICY, LEARNING_DASHBOARD_ENABLED,
                         LEARNING_DASHBOARD_CLEANUP_DELAY_IN_MINUTES, LOCK_SETTINGS_DISABLE_CAM, LOCK_SETTINGS_DISABLE_MIC,
                         ...
                         MAX_PARTICIPANTS, MEETING_KEEP_EVENT, MEETING_LAYOUT, MODERATOR_ONLY_MESSAGE, MUTE_ON_START, RECORD, VOICE_BRIDGE,
                         WEBCAMS_ONLY_FOR_MODERATOR, WELCOME]
