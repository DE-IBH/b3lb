# Generated by Django 3.2.16 on 2023-02-16 14:22
...
def create_default_record_profile(apps, schema_editor):
    ...
    profile.width = 1920
    profile.height = 1080
    profile.webcam_size = 0
    profile.crop_webcam = False
    profile.stretch_webcam = False
    profile.backdrop = ""
    profile.annotations = True
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('backdrop', models.CharField(default='', max_length=255)),
                ('annotations', models.BooleanField(default=True, help_text='Show annotations in video')),
                ('mime_type', models.CharField(default='video/mp4', max_length=32, help_text="video mime type, can be 'video/mp4' or 'video/webm'")),
                ('file_extension', models.CharField(default='mp4', max_length=10, help_text="video format, can be 'mp4' or 'webm'")),
