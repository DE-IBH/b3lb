# Generated by Django 3.2.19 on 2023-06-29 13:16

from django.db import migrations, models

def preserve_sha_configuration(apps, schema_editor):
    ClusterGroupRelation = apps.get_model("rest", "ClusterGroupRelation")
    for cluster_group_relation in ClusterGroupRelation.objects.all():
        cluster_group_relation.cluster.sha_function = cluster_group_relation.cluster_group.sha_function
        cluster_group_relation.cluster.save()

class Migration(migrations.Migration):

    dependencies = [
        ('rest', '0012_add_recordings_and_more'),
    ]
